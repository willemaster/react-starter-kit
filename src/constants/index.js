...
export const TOGGLE_CANVAS_CELL = 'TOGGLE_CANVAS_CELL';
export const SUBMIT_CANVAS_START = 'SUBMIT_CANVAS_START';
export const SUBMIT_CANVAS_COMPLETE = 'SUBMIT_CANVAS_COMPLETE';
export const SUBMIT_CANVAS_ERROR = 'SUBMIT_CANVAS_ERROR';
